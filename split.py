...
json_path = r'F:\TinHoc\BinningMini\RAG + langchain\crawl\data\links.json'
...
txt_folder = r"F:\TinHoc\BinningMini\RAG + langchain\crawl\data\tvpl_new\docs"
output_root = r"F:\TinHoc\BinningMini\RAG + langchain\crawl\domain_split_new"
