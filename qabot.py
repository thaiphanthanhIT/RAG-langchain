...
from models.adaptive_rag.main_arag import GraphState, adaptive_rag_graph
...
if __name__ == "__main__":
    ...
    state: GraphState = {"question": "", "generation": None, "documents": [], "retry_count": 0 ,"history": []}  # Trạng thái ban đầu
    ...
    while True:
        try:
            ...
            # Chạy graph
            final_state = adaptive_rag_graph.invoke(state)
